...
def upsample_3d(x, k=None, factor=2, gain=1, padding=0, data_format='NCDHW', impl='ref'):
    ...
    pad0 = (k.shape[0] + factor - 1) // 2 + padding
    pad1 = (k.shape[0] - factor) // 2 + padding


    # print( "===========================" )
    # print( "upsample_3d : pad0, pad1" )
    # print( pad0 )
    # print( pad1 )
    # print( "===========================" )
...
def downsample_3d(x, k=None, factor=2, gain=1, padding=0, data_format='NCDHW', impl='ref'):
...
def upsample_conv_3d(x, w, k=None, factor=2, gain=1, padding=0, data_format='NCDHW', impl='ref'):
    ...
    pad0 = (k.shape[0] + factor - convW) // 2 + padding
    pad1 = (k.shape[0] - factor - convW + 3) // 2 + padding

    

    # print( "===========================" )
    # print( "upsample_conv_3d : pad0, pad1" )
    # print( pad0 )
    # print( pad1 )
    # print( "===========================" )
...
def conv_downsample_3d(x, w, k=None, factor=2, gain=1, padding=0, data_format='NCDHW', impl='ref'):
    ...
    pad0 = (k.shape[0] - factor + convW) // 2 + padding * factor
    pad1 = (k.shape[0] - factor + convW - 1) // 2 + padding * factor

    # pad0 = (k.shape[0] + factor - convW) // 2 + padding
    # pad1 = (k.shape[0] - factor - convW + 3) // 2 + padding

    # print( "===========================" )
    # print( "conv_downsample_3d : pad0, pad1" )
    # print( pad0 )
    # print( pad1 )
    # print( "===========================" )
